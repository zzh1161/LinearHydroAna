#ifndef LIN_SYS_SOLVER_HPP
#define LIN_SYS_SOLVER_HPP
...
public:
    ...
    virtual void setCoeff(const LinSysSolver<vectorTypeI, vectorTypeS>* other, double multiplier)
    {
    ...
    virtual const std::vector<std::map<int, int>>& getIJ2aI(void) const { return IJ2aI; }
...
template <typename vectorTypeI, typename vectorTypeS>
void LinSysSolver<vectorTypeI, vectorTypeS>::load(const char* filePath, Eigen::VectorXd& rhs)
{
...
template <typename vectorTypeI, typename vectorTypeS>
void LinSysSolver<vectorTypeI, vectorTypeS>::write(const char* filePath, const Eigen::VectorXd& rhs)
{
...
template <typename vectorTypeI, typename vectorTypeS>
void LinSysSolver<vectorTypeI, vectorTypeS>::set_pattern(const Eigen::SparseMatrix<double>& mtr)
{
...
template <typename vectorTypeI, typename vectorTypeS>
void LinSysSolver<vectorTypeI, vectorTypeS>::multiply(const Eigen::VectorXd& x, Eigen::VectorXd& Ax)
{
